...
import {HourRealService} from "../../../services/hour-real/hour-real.service";

@Component({
  selector: 'app-upload-hour-real',
  templateUrl: './upload-hour-real.component.html',
  styleUrls: ['./upload-hour-real.component.css']
})
export class UploadHourRealComponent implements OnInit {
  ...
  constructor(private service: HourRealService) {
  }
